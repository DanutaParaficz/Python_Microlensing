...
source_list=np.loadtxt(open("/Users/danka/Documents/MY_PUBLICATIONS/PremodialBHMicrolensing/WFI2033_noshifts_Euler.txt","rb"))
...
ax1.scatter(np.array(source_list[:,0]), np.array(magA)+0.8,edgecolor='None',c='r',s=3, label="A")
...
ax1.set_xlim(min(np.array(source_list[:,0]))-20.,max(np.array(source_list[:,0]))+20.)
ax1.set_ylim(-9.8,-11.8)
new_tick_locations = np.array([52500, 53500, 54500,55500,56500,57500])
ax2.set_xlim(ax1.get_xlim())
ax2.set_xticks(new_tick_locations)
ax2.set_xticklabels(years)
plt.text(52890,-62.6, 'C',horizontalalignment='center',fontsize=12, color='green')
plt.text(52890,-35.5, 'B',horizontalalignment='center',fontsize=12, color='blue')
plt.text(52890,-11.05, 'A',horizontalalignment='center',fontsize=12, color='red')
plt.text(55000,-14.2, 'Lightcurves of WFI2033 quasar images ',horizontalalignment='center',fontsize=17)
plt.text(55000,-13.8, '(intrisic viariability of quasar + microlensing singal)',horizontalalignment='center',fontsize=17)
fname2='/Users/danka/Documents/MY_PUBLICATIONS/PremodialBHMicrolensing/All_WFI.pdf'
plt.savefig(fname2)
...
fname2='/Users/danka/Documents/MY_PUBLICATIONS/PremodialBHMicrolensing/FBFC_WFI.pdf'
plt.savefig(fname2)
...
plt.text(55000,1.7, 'Microlensing signal in WFI2033 quasar images ',horizontalalignment='center',fontsize=17)

fname2='/Users/danka/Documents/MY_PUBLICATIONS/PremodialBHMicrolensing/FB_WFI.pdf'
plt.savefig(fname2)
